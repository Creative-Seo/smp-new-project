...
$description = '';
$article = 'Группа компаний «КАМАЗ» — крупнейшая автомобильная корпорация Российской Федерации. ПАО «КАМАЗ» занимает 11-е место среди ведущих мировых производителей тяжёлых грузовых автомобилей.';
$keywords = '';

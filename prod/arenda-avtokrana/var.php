...
$article = 'В нашем автопарке представлен широкий выбор кранов, грузоподъемностью от 14 до 60 тонн, с длиной стрелы от 22 до 47 метров. Предоставляем технику в аренду во Владимире и по всей области.';
